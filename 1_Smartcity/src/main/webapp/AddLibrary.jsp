			...
			<div id="addLibrary_div1">
				<fieldset>
					...
					<label id="lname">Name of library:</label><input type="text"
						name="libraryName" id="libraryName">&nbsp<span id="e_1"></span><br>
					<label>Place:</label> <input type="text" name="libraryPlace"
						id="libraryPlace">&nbsp<span id="e_2"></span><br> <label
						for="librarytype">Owned by:</label> <input type="text"
						name="libraryOwn" id="libraryOwn">&nbsp<span id="e_3"></span><br>
					<label for="time">Timing</label><input type="time"
						name="libraryOtime" id="libraryOtime"><label for="to"
						id="to">To</label><input type="time" id="libraryCtime"
						name="libraryCtime"><br> <label for="libraryaddress">Address</label><br>
					<textarea name="libraryAddress" id="libraryAddress" rows="4"
						cols="30"></textarea>
					<span id="e_7"></span> <br> <label>Email</label><input
						type="email" name="libraryEmail" id="libraryEmail">&nbsp<span
						id="e_4"></span><br> <label> Website </label><input
						type="url" name="libraryWebsite" id="libraryWebsite"
						value="https://">&nbsp<span id="e_5"></span><br> <label>Contact
						Number</label><input type="tel" name="libraryPhone" id="libraryPhone">&nbsp<span
						id="e_6"></span><br> <label>About Library</label><br>
